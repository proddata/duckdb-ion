...
> NOTE: This file is the original template README from `duckdb/extension-template`. It is retained for reference.
> The active README for this repository is `docs/NEXT_README.md`, which documents the Ion extension.
